#pragma once
#pragma intrinsic(memcmp, memset, memcpy,strcpy,strcmp,strlen)
#include <windows.h>
#include <process.h>
#include <winternl.h>
#include <imagehlp.h>
...
RPCRTAPI RPC_STATUS RPC_ENTRY RPCRT4$RpcStringBindingComposeW(RPC_WSTR ObjUuid,RPC_WSTR Protseq,RPC_WSTR NetworkAddr,RPC_WSTR Endpoint,RPC_WSTR Options,RPC_WSTR *StringBinding);
RPCRTAPI RPC_STATUS RPC_ENTRY RPCRT4$RpcBindingFromStringBindingW(RPC_WSTR StringBinding,RPC_BINDING_HANDLE *Binding);
RPCRTAPI RPC_STATUS RPC_ENTRY RPCRT4$RpcStringFreeW(RPC_WSTR *String);
RPCRTAPI RPC_STATUS RPC_ENTRY RPCRT4$RpcBindingFree(RPC_BINDING_HANDLE *Binding);
RPCRTAPI CLIENT_CALL_RETURN RPC_VAR_ENTRY RPCRT4$NdrClientCall2(PMIDL_STUB_DESC pStubDescriptor,PFORMAT_STRING pFormat,...);
